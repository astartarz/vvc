(function ($, Drupal, drupalSettings, window) {
  ...
  Drupal.behaviors.theme = {
    attach: function (context, settings) {
      // Hero Slideshow hide arrows
      if ($(document).find(".hero-slideshow > .slides > li").length == 1) {
        $(".hero-slideshow > .controls").hide();
      }

      $(".view-story-cards.view-display-id-default .student-story-card").hover(
        function () {
          $(".student-story-card .video-teaser").addClass("hide-item");
          $('.student-story-card:not(".opened-video") .video-full').addClass(
            "hide-item"
          );
          $(".student-story-card .open-video").addClass("hide-item");
          $('.student-story-card:not(".opened-video") .close-video').addClass(
            "hide-item"
          );
          $('.student-story-card:not(".opened-video") .card-img').removeClass(
            "hide-item"
          );
          $(".student-story-card").removeClass("opened-teaser");
          $('.student-story-card:not(".opened-video")').removeClass(
            "opened-video"
          );
      ...
      $(
        ".view-story-cards.view-display-id-default .student-story-card"
      ).mouseleave(function () {
        $(".student-story-card .video-teaser").addClass("hide-item");
        $('.student-story-card:not(".opened-video") .video-full').addClass(
          "hide-item"
        ...
        $('.student-story-card:not(".opened-video") .card-content').removeClass(
          "hide-item"
        );
      });

      $(".view-story-cards.view-display-id-default .student-story-card").bind(
        "click",
        function (event) {
          event.preventDefault();
          $(".student-story-card-wrapper")
            .find(".close-video")
            .addClass("hide-item");
          $(".student-story-card .video-teaser").addClass("hide-item");
          $(".student-story-card .video-full").addClass("hide-item");
          $(this)
            .parents(".student-story-card-wrapper")
            .find(".close-video")
            .removeClass("hide-item");
          $(".student-story-card .card-img").removeClass("hide-item");
          $(".student-story-card")
            .removeClass("opened-teaser")
            .removeClass("opened-video");
          $(".student-story-card")
            .find(".card-content")
            .removeClass("hide-item");
      ...
      $(".view-story-cards.view-display-id-default .close-video").bind(
        "click",
        function (event) {
          event.preventDefault();
  ...
  Drupal.behaviors.equalHeight = {
    attach: function (context, settings) {
      var social_grid_row = $(
        ".paragraph--type--social-grid .views-row",
        context
      );
  ...
  Drupal.behaviors.sidebarMenus = {
    attach: function (context, settings) {
      ...
      if (
        $(
          "aside.layout-sidebar-right .region-sidebar-right #block-vvc-sidebarcontent"
        ).length > 0
      ) {
        $("aside.layout-sidebar-right .region-sidebar-right").addClass(
          "sidebar-content"
        );
      }
    },
  ...
  $(document).ready(function () {
    ...
    if (
      $(document).find(
        ".paragraph--type--adjustable-media-and-content .field--name-field-media-video-file #play_button"
      ).length == 0
    ) {
      $(document)
        .find(
          ".paragraph--type--adjustable-media-and-content .field--name-field-media-video-file video"
        )
        .removeAttr("controls")
        .trigger("pause");
      $(document)
        .find(
          ".paragraph--type--adjustable-media-and-content .field--name-field-media-video-file"
        )
        .append(
          '<button type="button" class="play" id="play_button">Play</button>'
        );
    }
    ...
    $(".paragraph--type--image-carousel .image-carousel").slick({
      ...
      arrows: true,
      prevArrow: $(
        ".paragraph--type--image-carousel .slide-arrows .slide-prev"
      ),
      nextArrow: $(
        ".paragraph--type--image-carousel .slide-arrows .slide-next"
      ),
      asNavFor: ".image-nav",
      fade: true,
    });
    ...
    $(
      ".paragraph--type--news-banner .articles-carousel .field--name-field-articles-banner-nodes"
    ).slick({
      slidesToShow: 1,
      slidesToScroll: 1,
      arrows: true,
      ...
      autoplay: true,
      prevArrow: $(
        ".paragraph--type--news-banner .articles-carousel .slide-arrows .slide-prev"
      ),
      nextArrow: $(
        ".paragraph--type--news-banner .articles-carousel .slide-arrows .slide-next"
      ),
    });
    $(
      ".paragraph--type--news-banner .articles-carousel .custom-controls .btnPlay"
    ).on("click", function () {
    ...
    $(
      ".paragraph--type--news-banner .articles-carousel .slide-arrows .slick-arrow a"
    ).on("click", function (e) {
      e.preventDefault();
    });
    ...
    $(".utility-nav-block a.search-item").click(function (e) {
      ...
      $(".region-utility .desktop-search.active")
        .find(".form-type-textfield input")
        .focus();
    });
    ...
    $(document)
      .find(
        ".paragraph--type--image-carousel .slide-arrows a, .paragraph--type--image-carousel .image-nav a"
      )
      .on("click", function (e) {
        e.preventDefault();
      });
    ...
    setTimeout(function () {
      $(document)
        .find(".paragraph--type--image-carousel .image-nav .slick-slide")
        .each(function () {
    ...
    $(
      ...
      function () {
        $(".view-programs-gridder .view-header .container .information").css(
          "display",
          "block"
        );
      },

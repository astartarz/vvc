...
class AutocompleteDeluxeWidget extends WidgetBase implements ContainerFactoryPluginInterface {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    $element['new_terms'] = [
      ...
      '#description' => $this->t('Should it be allowed, that user enter new terms?. Note: User must have the "allow new terms" permission.'),
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    // term.
    if ($this->getSetting('new_terms') &&  \Drupal::currentUser()->hasPermission('allow new terms') && $this->getSelectionHandlerSetting('auto_create') && ($bundle = $this->getAutocreateBundle())) {
      $element['#autocreate'] = [
        'bundle' => $bundle,
